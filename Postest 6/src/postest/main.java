...
public class main {
    ...
    private static void tambahPenjual() throws IOException {
        ...
        Penjual jual = new Penjual (penjual, kondisi, merk, type, warna, tahun, harga, jenis);
    ...
    private static void tambahPembeli() throws IOException {
        ...
        Pembeli mobil = new Pembeli(pembeli, nomor, merk, type, warna, tahun, harga, jenis);
    ...
    private static void tampilkanPenjual() {
        ...
        if (dataPenjual.size() == 0) {
            ...
            for (int i = 0; i < dataPenjual.size(); i += 1) {
                ...
                System.out.println("Jenis           : " + dataPembeli.get(i).getJenis());
